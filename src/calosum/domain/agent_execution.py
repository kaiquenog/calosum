...
class AgentExecutionEngine:
    ...
    async def run_variant(
        ...
        *,
        ...
        left_result, execution_results, retry_count = await self._execute_with_retries(
            user_turn=user_turn,
    ...
    async def _execute_with_retries(
        ...
        *,
    ...
    ) -> tuple[LeftHemisphereResult, list[ActionExecutionResult], int]:
        retry_count = 0
        ...
        while True:
            ...
            if not rejected_results or retry_count >= self.max_runtime_retries:
                return current_result, execution_results, retry_count
    ...
    async def _repair_left_result(
        ...
        *,
        ...
        feedback = self._format_runtime_feedback(rejected_results)
        return await maybe_await(
            self.call_component(
                left_hemisphere,
                "areason",
