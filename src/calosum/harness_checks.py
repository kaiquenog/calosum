...
MODULE_RULES: dict[str, set[str]] = {
    ...
    "shared.models.ports": {"shared.models.types", "domain.metacognition.metacognition"},
    ...
    "domain.execution.runtime": {"domain.execution.runtime_dsl", "shared.models.types"},
    "domain.execution.runtime_dsl": {"shared.models.types"},
    ...
    "domain.metacognition.awareness": {"shared.models.types", "domain.metacognition.introspection", "domain.agent.orchestrator", "domain.agent.directive_guardrails"},
    ...
    "adapters.tools.introspection": {"shared.models.types"},
