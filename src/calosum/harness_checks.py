...
MODULE_RULES: dict[str, set[str]] = {
    ...
    "domain.metacognition.introspection_capabilities": {
        ...
        "bootstrap.wiring.operational_budget",
        "shared.models.types",
    },
    ...
    "bootstrap.wiring.operational_budget": set(),
    "bootstrap.wiring.factory": {
        "adapters.perception.simple_distance",
    ...
    "adapters.hemisphere.input_perception_vjepa21": {"shared.models.types", "shared.models.ports", "shared.utils.math_cognitive"},
    "adapters.hemisphere.input_perception_vljepa": {
        "adapters.hemisphere.input_perception_vjepa21",
        "shared.models.types",
        "shared.utils.math_cognitive",
    },
    "adapters.hemisphere.soft_prompt_projector": {"shared.models.types"},
    ...
    "adapters.perception.active_inference": {"shared.models.types", "shared.utils.math_cognitive"},
