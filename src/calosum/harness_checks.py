...
MODULE_RULES: dict[str, set[str]] = {
    ...
    "bootstrap.api": {
        "adapters.communication.channel_telegram", "bootstrap.factory", "bootstrap.settings", "domain.introspection",
    ...
    "adapters.bridge.bridge_store": {"shared.ports"},
    "adapters.communication.channel_telegram": {"shared.types"},
    "adapters.communication.latent_exchange": {"shared.ports", "domain.event_bus"},
    "adapters.communication.telemetry_otlp": {"domain.telemetry"},
    "adapters.contract_wrappers": {"shared.types"},
    "adapters.experience.gea_experience_distributed": set(),
    "adapters.experience.gea_experience_graph": {"shared.ports"},
    "adapters.experience.gea_experience_store": set(),
    "adapters.experience.gea_reflection_experience": {"domain.bridge", "domain.metacognition"},
    "adapters.hemisphere.left_hemisphere_rlm": {"shared.types", "shared.ports"},
    "adapters.hemisphere.right_hemisphere_hf": {"shared.types", "domain.right_hemisphere", "shared.ports"},
    "adapters.hemisphere.right_hemisphere_jepars": {"shared.types"},
    "adapters.hemisphere.right_hemisphere_vjepa21": {"shared.types", "shared.ports"},
    "adapters.hemisphere.right_hemisphere_vljepa": {"adapters.hemisphere.right_hemisphere_vjepa21", "shared.types"},
    "adapters.knowledge.knowledge_graph_nanorag": {"shared.types"},
    "adapters.llm.llm_failover": {"shared.async_utils", "shared.ports", "shared.types"},
    "adapters.llm.llm_payload_parser": {"shared.types"},
    "adapters.llm.llm_payloads": {"shared.types"},
    "adapters.llm.llm_qwen": {"adapters.llm.llm_payloads", "adapters.llm.llm_payload_parser", "shared.async_utils", "shared.types"},
    "adapters.memory.memory_qdrant": {
        "adapters.memory.text_embeddings",
    ...
    "adapters.memory.memory_qdrant_serializers": {"shared.types", "shared.ports"},
    "adapters.memory.text_embeddings": {"shared.async_utils", "shared.ports"},
    ...
    "adapters.perception.active_inference": {"shared.types", "domain.right_hemisphere"},
    "adapters.perception.multimodal_perception": {"shared.ports"},
    "adapters.perception.quantized_embeddings": {"shared.ports"},
